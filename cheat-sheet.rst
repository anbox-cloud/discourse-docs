...
.. admonition:: Question
   ...
   Do we want to require a certain sequence of underline characters, or should that be flexible (for each project, or even for each page)?
...
For external links, use only the URL, or rST syntax if you want to override the link text.
...
.. list-table::
   ...
   * - ``https://anbox-cloud.io/``
     - https://anbox-cloud.io/
   * - ```Anbox Cloud website <https://anbox-cloud.io/>`_``
     - `Anbox Cloud website <https://anbox-cloud.io/>`_
...
.. list-table::
   ...
   * - ``:doc:`exp/anbox-cloud```
     - :doc:`exp/anbox-cloud`
   * - ``:doc:`Link text <exp/anbox-cloud>```
     - :doc:`Link text <exp/anbox-cloud>`
   * - ``:doc:`lxd:index```
     - :doc:`lxd:index`
   * - ``:doc:`Link text <lxd:index>```
     - :doc:`Link text <lxd:index>`
...
.. list-table::
   ...
   * - Input
     - Output
   * - ``.. image:: /images/virtual_device_launch.png``
     - .. image:: /images/virtual_device_launch.png
   * - .. code::
...
.. list-table::
   ...
   * - .. code::
          ...
          .. include:: exp/anbox-cloud.rst
             :start-after: depends on your needs.
