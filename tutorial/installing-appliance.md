...
AWS supports running the Anbox Cloud Appliance the [AWS Graviton](https://aws.amazon.com/ec2/graviton/) Arm-based or x86 instances. Before installing the appliance, decide which architecture you want to use. The appliance supports the same set of features on both architectures, but you should factor in the following aspects:

* Generally both AWS Graviton and x86 offer equal performance for Android applications
